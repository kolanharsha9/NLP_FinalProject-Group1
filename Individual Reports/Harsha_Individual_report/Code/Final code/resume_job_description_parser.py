...
os.system('pip install json PyPDF2 google-generativeai chardet')
import json
import PyPDF2
...
def process_documents(api_key, resume_pdf_path, job_description_path):
    ...
    try:
        ...
        # Read and clean job description with encoding detection
...
def main():
    ...
    job_description_path = 'Processed_jd/Data_scientist.txt'
